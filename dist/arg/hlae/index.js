...
var GameEventUnserializer_1 = __importDefault(require("./GameEventUnserializer"));
var MIRVPGL = /** @class */ (function () {
    function MIRVPGL(server) {
        ...
        this.init = function (server) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                server.onConnection(function (simpleSocket) {
                    var newSocket = simpleSocket._socket;
                    ...
                    socket.on('message', function (data) {
                        ...
                        var bufferReader = new BufferReader_1["default"](Buffer.from(data));
                        try {
